...
We used three groups - L1, L2 and L3 diets - to calculate DEGs. L1 diet is used as control.
...
We used [DESeq2](https://bioconductor.org/packages/release/bioc/html/DESeq2.html) to calculate LFCs (log-fold changes) and adjusted p-values. Positive LFCs indicate up-regulation, whereas negative LFCs indicate down-regulation based on the L1 expression level. We used the following criteria to define our DEGs.
...
## Analysis of DEGs
DEGs are further analysed with various to understand the genetic regulations affected by micronutrients.
